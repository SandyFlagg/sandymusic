        ...
        <section id="contact" className="py-24 lg:py-32 px-6 border-t border-white/5 bg-[#0a0a0a] relative overflow-hidden">
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    {/* Right: Instagram CTA */}
                    <div className="bg-[#111] p-8 md:p-12 rounded-[2.5rem] border border-white/10 relative group overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-start gap-8">
                            ...
                            <a
                                ...
                                className="inline-flex items-center justify-center gap-3 w-full h-16 bg-white text-black font-black uppercase tracking-[0.2em] rounded-full hover:bg-accent hover:text-white transition-all duration-300 shadow-lg hover:shadow-orange-500/20 hover:-translate-y-1 active:scale-95"
                            >
                                Send me a DM
